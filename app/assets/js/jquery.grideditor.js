    ...
    self.each(function(baseIndex, baseElem) {
        ...
        function createRowControls() {
            canvas.find('.row').each(function() {
                ...
                createTool(drawer, 'Move', 'ge-move air-block-op', 'glyphicon-move');
                createTool(drawer, 'Settings', 'air-block-op', 'glyphicon-cog', function() {
                    details.toggle();
                });
                settings.row_tools.forEach(function(t) {
                    createTool(drawer, t.title || '', t.className || '', t.iconClass || 'glyphicon-wrench', t.on);
                });
                createTool(drawer, 'Remove row', 'air-block-op', 'glyphicon-trash', function() {
                ...
                createTool(drawer, 'Add column', 'ge-add-column air-block-op', 'glyphicon-plus-sign', function() {
        ...
        function createBlockControls() {
            canvas.find('#airblock_editor .airblock').each(function() {
                var row = $(this);
                if (row.find('> .ge-tools-drawer').length) { return; }
        ...
        function makeSortable() {
            canvas.find('#airblock').sortable({
                items: '> .column',
                connectWith: '.ge-canvas .airblock',
